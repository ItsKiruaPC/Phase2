...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 26 avr. 2023 à 18:35
...
(3, 'Star Wars : L\'Ascension de Skywalker', 'J.J. Abrams, Adam Driver, Daisy Ridley, Oscar Isaac', 'Daisy Ridley, Adam Driver, Oscar Isaac, Keri Russell, John Boyega, Billy Dee Williams, Carrie Fisher, Mark Hamill et bien d\'autres...', '2h22', 'La conclusion de la saga Skywalker. De nouvelles légendes vont naître dans cette bataille épique pour la liberté.', 'https://www.pathe.fr/films/star-wars-l-ascension-de-skywalker', 'starwars.jpg', 10);
...
INSERT INTO `reservation` (`noresa`, `mdpresa`, `dateresa`, `nomclient`, `nbplaceresa`, `noproj`) VALUES
(297, 'RAgb4O', '2023-03-06', 'fevre', 5, 3),
(298, 'gJPRhq', '2023-03-28', 'fevre', 5, 3);
